          ...
          >
            <div className="hero-section" style={{ backgroundImage: `url(${slide.bg})` }}>
              ...
              <div className="absolute inset-0 z-[5]">
                ...
                <div className="absolute top-1/3 right-1/3 w-1.5 h-1.5 rounded-full bg-primary/40 animate-float-delayed" />
                <div className="absolute bottom-1/3 left-1/3 w-1 h-1 rounded-full bg-white/20 animate-float-slow" />
              </div>
